...
CREATE TABLE `alert` (
  ...
  KEY `email_idx` (`email`),
  CONSTRAINT `email` FOREIGN KEY (`email`) REFERENCES `users` (`username`),
...
INSERT INTO `orders` VALUES (22,'2022-05-10 15:46:45',240,'2022-05-19 22:00:00','2023-05-19 22:00:00','PAID','andrea',1,12,20),(23,'2022-05-10 15:46:58',240,'2022-05-24 22:00:00','2023-05-24 22:00:00','REJECTED','andrea',1,12,20),(24,'2022-05-10 15:47:17',240,'2022-05-13 22:00:00','2023-05-13 22:00:00','REJECTED','andrea',1,12,20);
...
INSERT INTO `users` VALUES ('andrea','1234','',1,2),('gianluca','1234','gianluca@gianluca.it',0,0);
...
-- Dump completed on 2022-05-10 17:59:57
